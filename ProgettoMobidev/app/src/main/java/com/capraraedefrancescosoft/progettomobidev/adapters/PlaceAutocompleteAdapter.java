...
/**
 * Created by Gianpaolo Caprara on 9/27/2016.
 */
public class PlaceAutocompleteAdapter extends ArrayAdapter<AutocompletePrediction> implements Filterable {
     ...
     * objects to store the Place ID and journal_description that the API returns.
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            ...
            if (!status.isSuccess()) {
                Toast.makeText(getContext(), "Error contacting API, please connect to internet" +
            ...
            System.out.println("Query completed. Received " + autocompletePredictions.getCount()
                    + " predictions.");
